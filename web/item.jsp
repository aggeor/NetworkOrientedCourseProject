            ...
            <form action="AddToCart" method="post">
                <div class="col-xs-4">
                    <div class="panel panel-default" >
                        <div class="panel-heading" id="data"><%=itemName%></div>
                ...
                <div class="col-xs-6">
                              ...
                              <%if(itemDesc!=null){
                                  itemDesc = ws.formatDescription(itemDesc);
                                }%>  
                    <div class="panel-body" align="left"><%=itemDesc%></div>
                    <div class="panel-footer">
                        <table>
                            <tr>
                                <td><div>Quantity :</div></td>
                                <td><input type="text" name="itemQuantity" value="1"/></td>
                            </tr>
                            <tr>
                                <td>
                                    
                                    <div id="itemPrice" name="itemPrice" value=""><span class="glyphicon glyphicon-euro"></span><%=itemPrice%></div>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    <input type="hidden" name="itemName" value="<%=itemName%>"/>
                                    <input type="hidden" name="itemImg" value="<%=itemImg%>"/>
                                    <input type="hidden" name="itemPrice" value="<%=itemPrice%>"/>
                                    <input type="hidden" name="itemDesc" value="<%=itemDesc%>"/>
                                    <button type="submit" class="btn"><span class="glyphicon glyphicon-shopping-cart"></span>Add to  cart</button>
                                </td>
                            </tr>
                        </table>
                    </div>
